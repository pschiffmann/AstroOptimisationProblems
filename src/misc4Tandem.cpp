...
// The following data refer to the Launcher Atlas501 performances as given by
// NASA
static const double x_atl[9] = {2.5, 3, 3.5, 4, 4.5, 5, 5.5, 5.75, 6};
static const double y_atl[13] = {-40, -30, -29,  -28.5, -20, -10, 0,
                                 10,  20,  28.5, 29,    30,  40};
...
// The following data refer to the Launcher Soyuz-Fregat performances as given
// by ESOC. The data here and consider
// an elaborated five impulse strategy to exploit the launcher performances as
// much as possible.
static const double x_sf[5] = {1, 2, 3, 4, 5};
static const double y_sf[15] = {-90, -65, -50, -40, -30, -20, -10, 0,
                                10,  20,  30,  40,  50,  65,  90};
