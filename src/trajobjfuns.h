...
// NOTE: the functions here have passing by reference + const as they are called
// a lot of time during execution and thus
// it is worth trying to save time by avoiding to make a copy of the variable
// passed
